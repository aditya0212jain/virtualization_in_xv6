...
00000362 <halt>:
SYSCALL(halt)
 362:	b8 1f 00 00 00       	mov    $0x1f,%eax
 367:	cd 40                	int    $0x40
 369:	c3                   	ret    
...
00000392 <print_count>:
SYSCALL(print_count)
 392:	b8 1b 00 00 00       	mov    $0x1b,%eax
 397:	cd 40                	int    $0x40
 399:	c3                   	ret    
...
000003aa <sigraise>:
SYSCALL(sigraise)
 3aa:	b8 1e 00 00 00       	mov    $0x1e,%eax
 3af:	cd 40                	int    $0x40
 3b1:	c3                   	ret    
 ...
 3d9:	85 d2                	test   %edx,%edx
{
 ...
 440:	e8 9d fe ff ff       	call   2e2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4b0:	e8 2d fe ff ff       	call   2e2 <write>
 ...
 528:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 52a:	e8 b3 fd ff ff       	call   2e2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5c3:	57                   	push   %edi
 5c4:	53                   	push   %ebx
 5c5:	e8 18 fd ff ff       	call   2e2 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 72e:	56                   	push   %esi
 72f:	e8 16 fc ff ff       	call   34a <sbrk>
  if(p == (char*)-1)
