...
int             receive_message_test(int myid,void* msg);
int             receive_msg(int myid,void* msg);
int             send_message(int s_pid,int r_id,void *msg);
int             isReceiverQueueEmpty(int myid);
