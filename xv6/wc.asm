...
00000472 <halt>:
SYSCALL(halt)
 472:	b8 1f 00 00 00       	mov    $0x1f,%eax
 477:	cd 40                	int    $0x40
 479:	c3                   	ret    
...
000004b2 <signal>:
SYSCALL(signal)
 4b2:	b8 1d 00 00 00       	mov    $0x1d,%eax
 4b7:	cd 40                	int    $0x40
 4b9:	c3                   	ret    

000004ba <sigraise>:
SYSCALL(sigraise)
 4ba:	b8 1e 00 00 00       	mov    $0x1e,%eax
 4bf:	cd 40                	int    $0x40
 4c1:	c3                   	ret    
 ...
 4e9:	85 d2                	test   %edx,%edx
{
 ...
 550:	e8 9d fe ff ff       	call   3f2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c0:	e8 2d fe ff ff       	call   3f2 <write>
 ...
 621:	e8 cc fd ff ff       	call   3f2 <write>
 ...
 638:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 63a:	e8 b3 fd ff ff       	call   3f2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 6d3:	57                   	push   %edi
 6d4:	53                   	push   %ebx
 6d5:	e8 18 fd ff ff       	call   3f2 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 83e:	56                   	push   %esi
 83f:	e8 16 fc ff ff       	call   45a <sbrk>
  if(p == (char*)-1)
