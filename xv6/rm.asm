...
00000372 <halt>:
SYSCALL(halt)
 372:	b8 1f 00 00 00       	mov    $0x1f,%eax
 377:	cd 40                	int    $0x40
 379:	c3                   	ret    
 ...
 3e9:	85 d2                	test   %edx,%edx
{
 ...
 417:	f7 f1                	div    %ecx
 419:	0f b6 92 0c 08 00 00 	movzbl 0x80c(%edx),%edx
  }while((x /= base) != 0);
 ...
 450:	e8 9d fe ff ff       	call   2f2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4c0:	e8 2d fe ff ff       	call   2f2 <write>
 ...
 538:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 53a:	e8 b3 fd ff ff       	call   2f2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5d3:	57                   	push   %edi
 5d4:	53                   	push   %ebx
 5d5:	e8 18 fd ff ff       	call   2f2 <write>
        while(*s != 0){
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb 05 08 00 00       	mov    $0x805,%ebx
        while(*s != 0){
 ...
 651:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 bc 0a 00 00       	mov    %eax,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73e:	56                   	push   %esi
 73f:	e8 16 fc ff ff       	call   35a <sbrk>
  if(p == (char*)-1)
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 7a7:	0a 00 00 
 7aa:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 c0 0a 00 00       	mov    $0xac0,%eax
 7b9:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 7c0:	00 00 00 
