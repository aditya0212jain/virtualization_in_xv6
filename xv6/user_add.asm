...
_user_add:     file format elf32-i386
...
//   printf(1,"The size of my address space is %d bytes\n", getmysize());
  ...
  2b:	50                   	push   %eax
  2c:	56                   	push   %esi
  2d:	e8 20 03 00 00       	call   352 <add>
  32:	83 c4 0c             	add    $0xc,%esp
  35:	50                   	push   %eax
  36:	68 a8 07 00 00       	push   $0x7a8
  3b:	6a 01                	push   $0x1
  3d:	e8 0e 04 00 00       	call   450 <printf>
  exit();
...
00000342 <halt>:
SYSCALL(halt)
 342:	b8 1f 00 00 00       	mov    $0x1f,%eax
 347:	cd 40                	int    $0x40
 349:	c3                   	ret    
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 420:	e8 9d fe ff ff       	call   2c2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 490:	e8 2d fe ff ff       	call   2c2 <write>
 ...
 508:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 50a:	e8 b3 fd ff ff       	call   2c2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5a3:	57                   	push   %edi
 5a4:	53                   	push   %ebx
 5a5:	e8 18 fd ff ff       	call   2c2 <write>
        while(*s != 0){
 ...
 5f7:	e8 c6 fc ff ff       	call   2c2 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 70e:	56                   	push   %esi
 70f:	e8 16 fc ff ff       	call   32a <sbrk>
  if(p == (char*)-1)
