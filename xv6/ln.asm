...
0000039a <sigraise>:
SYSCALL(sigraise)
 39a:	b8 1e 00 00 00       	mov    $0x1e,%eax
 39f:	cd 40                	int    $0x40
 3a1:	c3                   	ret    
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 430:	e8 9d fe ff ff       	call   2d2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a0:	e8 2d fe ff ff       	call   2d2 <write>
 ...
 518:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 51a:	e8 b3 fd ff ff       	call   2d2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5b3:	57                   	push   %edi
 5b4:	53                   	push   %ebx
 5b5:	e8 18 fd ff ff       	call   2d2 <write>
        while(*s != 0){
 ...
 631:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 90 0a 00 00       	mov    %eax,0xa90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 90 0a 00 00    	mov    0xa90,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 787:	0a 00 00 
 78a:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 94 0a 00 00       	mov    $0xa94,%eax
 799:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 7a0:	00 00 00 
