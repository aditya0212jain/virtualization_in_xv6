 ...
 4a9:	85 d2                	test   %edx,%edx
{
 ...
 510:	e8 9d fe ff ff       	call   3b2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 580:	e8 2d fe ff ff       	call   3b2 <write>
 ...
 5e1:	e8 cc fd ff ff       	call   3b2 <write>
 ...
 5f8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5fa:	e8 b3 fd ff ff       	call   3b2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 693:	57                   	push   %edi
 694:	53                   	push   %ebx
 695:	e8 18 fd ff ff       	call   3b2 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 74 0b 00 00       	mov    0xb74,%eax
{
 ...
 74d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 74f:	a3 74 0b 00 00       	mov    %eax,0xb74
}
 754:	5b                   	pop    %ebx
 755:	5e                   	pop    %esi
 756:	5f                   	pop    %edi
 ...
 766:	72 ce                	jb     736 <free+0x26>
{
 ...
 787:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 78a:	a3 74 0b 00 00       	mov    %eax,0xb74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 15 74 0b 00 00    	mov    0xb74,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 47                	jae    838 <malloc+0x98>
    ...
    if(p == freep)
 7f1:	39 05 74 0b 00 00    	cmp    %eax,0xb74
 7f7:	89 c2                	mov    %eax,%edx
 7f9:	75 ed                	jne    7e8 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 7fb:	83 ec 0c             	sub    $0xc,%esp
 7fe:	56                   	push   %esi
 7ff:	e8 16 fc ff ff       	call   41a <sbrk>
  if(p == (char*)-1)
 ...
 816:	e8 f5 fe ff ff       	call   710 <free>
  return freep;
 81b:	8b 15 74 0b 00 00    	mov    0xb74,%edx
 ...
 844:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 847:	89 15 74 0b 00 00    	mov    %edx,0xb74
}
 ...
 859:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 74 0b 00 00 78 	movl   $0xb78,0xb74
 867:	0b 00 00 
 86a:	c7 05 78 0b 00 00 78 	movl   $0xb78,0xb78
 871:	0b 00 00 
    base.s.size = 0;
 874:	b8 78 0b 00 00       	mov    $0xb78,%eax
 879:	c7 05 7c 0b 00 00 00 	movl   $0x0,0xb7c
 880:	00 00 00 
