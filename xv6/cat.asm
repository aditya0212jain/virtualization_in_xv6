...
00000402 <halt>:
SYSCALL(halt)
 402:	b8 1f 00 00 00       	mov    $0x1f,%eax
 407:	cd 40                	int    $0x40
 409:	c3                   	ret    
 ...
 479:	85 d2                	test   %edx,%edx
{
 ...
 4e0:	e8 9d fe ff ff       	call   382 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 550:	e8 2d fe ff ff       	call   382 <write>
 ...
 5c8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5ca:	e8 b3 fd ff ff       	call   382 <write>
  for(i = 0; fmt[i]; i++){
 ...
 663:	57                   	push   %edi
 664:	53                   	push   %ebx
 665:	e8 18 fd ff ff       	call   382 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7ce:	56                   	push   %esi
 7cf:	e8 16 fc ff ff       	call   3ea <sbrk>
  if(p == (char*)-1)
