 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 80 0e 00 00    	lea    0xe80(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 80 0e 00 00       	mov    $0xe80,%ebx
    buf[m] = '\0';
 26c:	c6 86 80 0e 00 00 00 	movb   $0x0,0xe80(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb 80 0e 00 00    	cmp    $0xe80,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 80 0e 00 00       	sub    $0xe80,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 80 0e 00 00       	push   $0xe80
...
free(void *ap)
{
 ...
 901:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 93d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 93f:	a3 60 0e 00 00       	mov    %eax,0xe60
}
 944:	5b                   	pop    %ebx
 945:	5e                   	pop    %esi
 946:	5f                   	pop    %edi
 ...
 956:	72 ce                	jb     926 <free+0x26>
{
 ...
 977:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 97a:	a3 60 0e 00 00       	mov    %eax,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 999:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 99c:	8b 15 60 0e 00 00    	mov    0xe60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9df:	73 47                	jae    a28 <malloc+0x98>
    ...
    if(p == freep)
 9e1:	39 05 60 0e 00 00    	cmp    %eax,0xe60
 ...
 a06:	e8 f5 fe ff ff       	call   900 <free>
  return freep;
 a0b:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 a34:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a37:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 a49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a50:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 a57:	0e 00 00 
 a5a:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 a61:	0e 00 00 
    base.s.size = 0;
 a64:	b8 64 0e 00 00       	mov    $0xe64,%eax
 a69:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 a70:	00 00 00 
