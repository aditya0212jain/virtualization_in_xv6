...
00000322 <halt>:
SYSCALL(halt)
 322:	b8 1f 00 00 00       	mov    $0x1f,%eax
 327:	cd 40                	int    $0x40
 329:	c3                   	ret    
...
00000352 <print_count>:
SYSCALL(print_count)
 352:	b8 1b 00 00 00       	mov    $0x1b,%eax
 357:	cd 40                	int    $0x40
 359:	c3                   	ret    
...
00000362 <signal>:
SYSCALL(signal)
 362:	b8 1d 00 00 00       	mov    $0x1d,%eax
 367:	cd 40                	int    $0x40
 369:	c3                   	ret    

0000036a <sigraise>:
SYSCALL(sigraise)
 36a:	b8 1e 00 00 00       	mov    $0x1e,%eax
 36f:	cd 40                	int    $0x40
 371:	c3                   	ret    
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 400:	e8 9d fe ff ff       	call   2a2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 470:	e8 2d fe ff ff       	call   2a2 <write>
 ...
 4d1:	e8 cc fd ff ff       	call   2a2 <write>
 ...
 4e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ea:	e8 b3 fd ff ff       	call   2a2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 18 fd ff ff       	call   2a2 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 34 0a 00 00       	mov    %eax,0xa34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 34 0a 00 00    	mov    0xa34,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 34 0a 00 00    	mov    0xa34,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 ...
 749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 757:	0a 00 00 
 75a:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 38 0a 00 00       	mov    $0xa38,%eax
 769:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 770:	00 00 00 
